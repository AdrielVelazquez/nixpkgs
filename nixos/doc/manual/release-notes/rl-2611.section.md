...
- [Fleet Orbit](https://fleetdm.com/guides/orbit), Fleet's lightweight osquery
  manager, is available through
  [services.orbit](#opt-services.orbit.enable). Enrollment uses a runtime
  secret file, Fleet Desktop is optional, and the package requires allowing
  its unfree Fleet Enterprise Edition license.
